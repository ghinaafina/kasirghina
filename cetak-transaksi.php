                ...
                <td>
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            $query2 = "SELECT id_produk, id_penjualan, jumlah_produk, sub_total FROM detailpenjualan WHERE id_detail = '" . $row['id_penjualan'] . "'";
                            ...
                            while ($detailrow = mysqli_fetch_assoc($result2)) {
                                ...
                                $totalproduk = $detailrow['jumlah_produk'] * $detailrow['sub_total'];
