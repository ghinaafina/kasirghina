                ...
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <table for="" class="form-label">id</table>
                      <input type="number" name="id_produk" class="form-control" require autofocus>
                    </div>
                    <div class="mb-3 mt-3">
...
if (isset($_POST['tambah'])) {
  ...
  if (move_uploaded_file($_FILES["foto"]["tmp_name"], $targetfile)) {
      $sql = "INSERT INTO produk (id_produk, nama_produk, harga, stok, foto) VALUES ('$id','$nama', '$harga', $stok, '$filename')";
